...
doAutopartition( PartitionCoreModule* core, Device* dev, Choices::AutoPartitionOptions o )
{
    ...
    {
        partType = PartitionTable::msdos;
        if ( isEfi || createHybridBootloaderLayout )
        {
            partType = PartitionTable::gpt;
        }
    }
    ...
    if ( createHybridBootloaderLayout || isEfi )
    {
        ...
        {
            // TODO: Avoid hardcoding 8 MiB?
            qint64 bios_part_sizeB = 8388608;
